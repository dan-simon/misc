...
function updateDisplay() {
  ...
  e[32].textContent = formatInt(2);
  e[33].textContent = formatInt(1);
  e[34].textContent = formatInt(2);
  e[35].textContent = formatInt(4);
  e[36].textContent = formatInt(1.5);
  e[37].textContent = formatInt(2);
  e[38].textContent = formatInt(2);
  e[39].textContent = formatInt(2);
  e[40].textContent = formatInt(2);
  e[41].textContent = formatInt(1);
  e[42].textContent = formatInt(2);
  e[43].textContent = format(Math.sqrt(2));
  e[44].textContent = formatInt(4);
  e[45].textContent = format(2);
  e[46].textContent = formatInt(4);
  e[47].textContent = formatInt(3);
  e[48].textContent = formatInt(3);
  e[49].textContent = formatInt(0);
  e[50].textContent = formatInt(1);
  e[51].textContent = formatInt(4);
  e[52].textContent = formatInt(2);
  e[53].textContent = formatInt(5);
  e[54].textContent = formatInt(4);
  e[55].textContent = format(formatWithPrecision(1 / 256, 5));
  e[56].textContent = formatInt(4);
  e[57].textContent = formatInt(8);
  e[58].textContent = formatInt(16);
  e[59].textContent = formatInt(2);
  e[60].textContent = formatInt(2048);
  e[61].textContent = formatInt(5);
  e[62].textContent = formatInt(6);
  e[63].textContent = formatInt(6);
  e[64].textContent = formatInt(5);
  e[65].textContent = formatInt(11);
  e[66].textContent = formatInt(16);
  e[67].textContent = formatInt(8);
  e[68].textContent = formatInt(2);
  e[69].textContent = format(2.25);
  e[70].textContent = formatInt(4);
  e[71].textContent = formatInt(16);
