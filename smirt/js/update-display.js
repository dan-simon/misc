...
function updateDisplay() {
  ...
  if (shouldUpdate("e75")) {e[75].textContent = Challenge.text(0)};
  if (shouldUpdate("e76")) {e[76].textContent = Challenge.nameOf(0)};
  if (shouldUpdate("e77")) {e[77].textContent = Challenge.name()};
  if (shouldUpdate("e78")) {e[78].textContent = formatInt(Zone.worldZone())};
  if (shouldUpdate("e79")) {e[79].textContent = formatInt(Challenge.goal())};
  if (shouldUpdate("e80")) {e[80].textContent = Zone.description()};
  if (shouldUpdate("e81")) {e[81].textContent = formatInt(Zone.cell())};
  if (shouldUpdate("e82")) {e[82].textContent = formatInt(Zone.attack())};
  if (shouldUpdate("e83")) {e[83].textContent = Zone.fighting() ? 'On' : 'Off'};
  if (shouldUpdate("e84")) {e[84].textContent = Zone.enemyName()};
  if (shouldUpdate("e85")) {e[85].textContent = formatInt(Zone.enemyHealth())};
  if (shouldUpdate("e86")) {e[86].textContent = formatInt(Zone.enemyMaxHealth())};
  if (shouldUpdate("e87")) {e[87].textContent = formatInt(Zone.enemyDefense())};
  if (shouldUpdate("e88")) {e[88].textContent = formatInt(Gold.gain())};
  if (shouldUpdate("e89")) {e[89].textContent = formatTime(player.stats.timeSincePortal, {seconds: {f: format, s: false}, larger: {f: format, s: false}})};
  ...
  if (shouldUpdate("b53")) {b[53].style.display = Challenge.isUnlocked(0) ? "" : "none"};
  if (shouldUpdate("b54")) {b[54].style.display = Challenge.isCompleted(0) ? "" : "none"};
  if (shouldUpdate("b55")) {b[55].style.display = Challenge.isSomeChallengeRunning() ? "" : "none"};
  if (shouldUpdate("b56")) {b[56].value = Zone.enemyHealthFraction()};
  if (shouldUpdate("b57")) {b[57].style.display = Gold.isVisible() ? "" : "none"};
  if (shouldUpdate("b58")) {b[58].className = Gold.canPortal() ? "" : "disabled"};
  if (shouldUpdate("b59")) {b[59].style.backgroundColor = Zone.getCellColor(8, 1)};
  if (shouldUpdate("b60")) {b[60].style.backgroundColor = Zone.getCellColor(8, 2)};
  if (shouldUpdate("b61")) {b[61].style.backgroundColor = Zone.getCellColor(8, 3)};
  if (shouldUpdate("b62")) {b[62].style.backgroundColor = Zone.getCellColor(8, 4)};
  if (shouldUpdate("b63")) {b[63].style.backgroundColor = Zone.getCellColor(8, 5)};
  if (shouldUpdate("b64")) {b[64].style.backgroundColor = Zone.getCellColor(8, 6)};
  if (shouldUpdate("b65")) {b[65].style.backgroundColor = Zone.getCellColor(8, 7)};
  if (shouldUpdate("b66")) {b[66].style.backgroundColor = Zone.getCellColor(8, 8)};
  if (shouldUpdate("b67")) {b[67].style.backgroundColor = Zone.getCellColor(7, 1)};
  if (shouldUpdate("b68")) {b[68].style.backgroundColor = Zone.getCellColor(7, 2)};
  if (shouldUpdate("b69")) {b[69].style.backgroundColor = Zone.getCellColor(7, 3)};
  if (shouldUpdate("b70")) {b[70].style.backgroundColor = Zone.getCellColor(7, 4)};
  if (shouldUpdate("b71")) {b[71].style.backgroundColor = Zone.getCellColor(7, 5)};
  if (shouldUpdate("b72")) {b[72].style.backgroundColor = Zone.getCellColor(7, 6)};
  if (shouldUpdate("b73")) {b[73].style.backgroundColor = Zone.getCellColor(7, 7)};
  if (shouldUpdate("b74")) {b[74].style.backgroundColor = Zone.getCellColor(7, 8)};
  if (shouldUpdate("b75")) {b[75].style.backgroundColor = Zone.getCellColor(6, 1)};
  if (shouldUpdate("b76")) {b[76].style.backgroundColor = Zone.getCellColor(6, 2)};
  if (shouldUpdate("b77")) {b[77].style.backgroundColor = Zone.getCellColor(6, 3)};
  if (shouldUpdate("b78")) {b[78].style.backgroundColor = Zone.getCellColor(6, 4)};
  if (shouldUpdate("b79")) {b[79].style.backgroundColor = Zone.getCellColor(6, 5)};
  if (shouldUpdate("b80")) {b[80].style.backgroundColor = Zone.getCellColor(6, 6)};
  if (shouldUpdate("b81")) {b[81].style.backgroundColor = Zone.getCellColor(6, 7)};
  if (shouldUpdate("b82")) {b[82].style.backgroundColor = Zone.getCellColor(6, 8)};
  if (shouldUpdate("b83")) {b[83].style.backgroundColor = Zone.getCellColor(5, 1)};
  if (shouldUpdate("b84")) {b[84].style.backgroundColor = Zone.getCellColor(5, 2)};
  if (shouldUpdate("b85")) {b[85].style.backgroundColor = Zone.getCellColor(5, 3)};
  if (shouldUpdate("b86")) {b[86].style.backgroundColor = Zone.getCellColor(5, 4)};
  if (shouldUpdate("b87")) {b[87].style.backgroundColor = Zone.getCellColor(5, 5)};
  if (shouldUpdate("b88")) {b[88].style.backgroundColor = Zone.getCellColor(5, 6)};
  if (shouldUpdate("b89")) {b[89].style.backgroundColor = Zone.getCellColor(5, 7)};
  if (shouldUpdate("b90")) {b[90].style.backgroundColor = Zone.getCellColor(5, 8)};
  if (shouldUpdate("b91")) {b[91].style.backgroundColor = Zone.getCellColor(4, 1)};
  if (shouldUpdate("b92")) {b[92].style.backgroundColor = Zone.getCellColor(4, 2)};
  if (shouldUpdate("b93")) {b[93].style.backgroundColor = Zone.getCellColor(4, 3)};
  if (shouldUpdate("b94")) {b[94].style.backgroundColor = Zone.getCellColor(4, 4)};
  if (shouldUpdate("b95")) {b[95].style.backgroundColor = Zone.getCellColor(4, 5)};
  if (shouldUpdate("b96")) {b[96].style.backgroundColor = Zone.getCellColor(4, 6)};
  if (shouldUpdate("b97")) {b[97].style.backgroundColor = Zone.getCellColor(4, 7)};
  if (shouldUpdate("b98")) {b[98].style.backgroundColor = Zone.getCellColor(4, 8)};
  if (shouldUpdate("b99")) {b[99].style.backgroundColor = Zone.getCellColor(3, 1)};
  if (shouldUpdate("b100")) {b[100].style.backgroundColor = Zone.getCellColor(3, 2)};
  if (shouldUpdate("b101")) {b[101].style.backgroundColor = Zone.getCellColor(3, 3)};
  if (shouldUpdate("b102")) {b[102].style.backgroundColor = Zone.getCellColor(3, 4)};
  if (shouldUpdate("b103")) {b[103].style.backgroundColor = Zone.getCellColor(3, 5)};
  if (shouldUpdate("b104")) {b[104].style.backgroundColor = Zone.getCellColor(3, 6)};
  if (shouldUpdate("b105")) {b[105].style.backgroundColor = Zone.getCellColor(3, 7)};
  if (shouldUpdate("b106")) {b[106].style.backgroundColor = Zone.getCellColor(3, 8)};
  if (shouldUpdate("b107")) {b[107].style.backgroundColor = Zone.getCellColor(2, 1)};
  if (shouldUpdate("b108")) {b[108].style.backgroundColor = Zone.getCellColor(2, 2)};
  if (shouldUpdate("b109")) {b[109].style.backgroundColor = Zone.getCellColor(2, 3)};
  if (shouldUpdate("b110")) {b[110].style.backgroundColor = Zone.getCellColor(2, 4)};
  if (shouldUpdate("b111")) {b[111].style.backgroundColor = Zone.getCellColor(2, 5)};
  if (shouldUpdate("b112")) {b[112].style.backgroundColor = Zone.getCellColor(2, 6)};
  if (shouldUpdate("b113")) {b[113].style.backgroundColor = Zone.getCellColor(2, 7)};
  if (shouldUpdate("b114")) {b[114].style.backgroundColor = Zone.getCellColor(2, 8)};
  if (shouldUpdate("b115")) {b[115].style.backgroundColor = Zone.getCellColor(1, 1)};
  if (shouldUpdate("b116")) {b[116].style.backgroundColor = Zone.getCellColor(1, 2)};
  if (shouldUpdate("b117")) {b[117].style.backgroundColor = Zone.getCellColor(1, 3)};
  if (shouldUpdate("b118")) {b[118].style.backgroundColor = Zone.getCellColor(1, 4)};
  if (shouldUpdate("b119")) {b[119].style.backgroundColor = Zone.getCellColor(1, 5)};
  if (shouldUpdate("b120")) {b[120].style.backgroundColor = Zone.getCellColor(1, 6)};
  if (shouldUpdate("b121")) {b[121].style.backgroundColor = Zone.getCellColor(1, 7)};
  if (shouldUpdate("b122")) {b[122].style.backgroundColor = Zone.getCellColor(1, 8)};
